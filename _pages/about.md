...
<div style="display:grid; grid-template-columns:repeat(2, minmax(0, 1fr)); gap:16px; margin: 1rem 0;">
  ...
  <div style="border:1px solid #e5e7eb; border-radius:14px; padding:14px; background:#fff;">
    <div style="font-weight:700; margin-bottom:6px;">Research pipeline</div>
    <div style="opacity:.85; line-height:1.6;">
      From data → modeling → validation → insights for drought and groundwater risk.
    </div>
    <div style="margin-top:10px;">
      <a href="https://scholar.google.com/citations?user=_rBmLxQAAAAJ&hl=en" style="text-decoration:none; font-weight:600;">See research →</a>
    </div>
  </div>
