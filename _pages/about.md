...
<div class="pinned-grid">
  ...
  <a class="pinned-card" href="/cv/">
    <span class="pin-badge">1</span>
    <div class="pinned-inner">
      <h3>Education</h3>
      <p>BSc Civil Engineering • MSc Water Resources (IUPWARE)</p>
    </div>
  </a>

  <a class="pinned-card" href="/research/">
    <span class="pin-badge">2</span>
    <div class="pinned-inner">
      <h3>Research</h3>
      <p>Soil moisture • Recharge • Unsaturated-zone modelling</p>
    </div>
  </a>

  <a class="pinned-card" href="/portfolio/">
    <span class="pin-badge">3</span>
    <div class="pinned-inner">
      <h3>Applied work</h3>
      <p>Water planning • Infrastructure • Nature-based solutions</p>
    </div>
  </a>

  <a class="pinned-card" href="/talks/">
    <span class="pin-badge">4</span>
    <div class="pinned-inner">
      <h3>Talks</h3>
      <p>EGU • SWAT conference • Stakeholder presentations</p>
    </div>
  </a>
